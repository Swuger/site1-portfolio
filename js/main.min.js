...
$((function(){function o(o){$(".modal__content").removeAttr("style"),setTimeout(()=>{o.removeClass("show"),$("body").removeClass("no-scroll")},200)}$("[data-modal]").on("click",(function(){const o=$(this).attr("data-modal"),s=$("#"+o);$(s).addClass("show"),$("body").addClass("no-scroll"),$(".modal__content").on("click",(function(o){o.stopPropagation()})),setTimeout(()=>{$(".modal__content").css({transform:"none",opacity:"1"})},1)})),$(".modal__close").on("click",(function(){o($(this).closest(".modal"))})),$(".modal").on("click",(function(){o($(this))}))})),$((function(){function o(){$("body").removeClass("show-sidebar"),$(".page__mask").remove()}$("#sidebarToggle").on("click",(function(){$("body").hasClass("show-sidebar")?o():function(){const s=$('<div class="page__mask"></div>');$(s).on("click",o),$(s).appendTo("#page"),$("body").addClass("show-sidebar")}()}))})),$((function(){const o=$("[data-autoresize]").height();$("[data-autoresize]").on("input",(function(){this.style.height=o+"px",this.style.height=this.scrollHeight+"px"}))}));
